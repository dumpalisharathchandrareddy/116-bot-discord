module.exports = {
  ...
  dualRoleTriggers: {
    ...
    thanks: {
      staff:
        "Your order makes a difference—thanks for being a great team member!",
    ...
    "good night": {
      ...
      user: "Good night! Hope to see you again. Don’t forget to leave a vouch if you enjoyed!",
    },
    bye: {
  ...
  userOnlyTriggers: {
    ...
    amazing:
      "Thank you so much! Don’t forget to vouch and mention staff if you’re happy.",
    appreciate:
    ...
    "i have paid":
      "Got it, thanks! We'll confirm soon. Consider leaving a vouch if you’re satisfied.",
    "payment done":
    ...
    "give me a minute": "Of course! We're here whenever you’re ready.",
    confirming: "We’re confirming your info. Hold tight, please!",
    checking: "Checking now—thanks for your patience.",
    "please wait": "Thank you for waiting! We’ll update you ASAP.",
    "order placed":
      "Your order’s in! We hope you enjoy. Please vouch after delivery!",
    "order done":
    ...
    problem:
      "Sorry for any issues! We’re here to help—just tag staff and explain.",
    "any update":
      "We’re working on it! If it’s been a while, feel free to ask for a status update.",
    "still waiting": "We apologize for the delay—checking on your order now.",
    "how long":
      "Estimated wait is about 4 minutes per open ticket. Thanks for your patience!",
    price: "Prices may vary—please send your cart link for a quote.",
    refund: "For refund questions, please explain the issue and tag staff.",
    cancel: "Need to cancel? Let us know and we’ll assist right away.",
